...
//below is all copy pasted
// Find the container element
const outEl = document.querySelector("#container");

    export const businessArray = () => {//add this line //add export to be used in other modules

        // Gather business information and store it in a variable
        let html = "<h1>Active Businesses</h1>";

        /*forEach instead of for of:*/
        //for (const singleBusiness of businesses){
        //     return `${singleBusiness.companyName}`
        //   }

        // Loop through the businesses array and append business information to the HTML string
        businesses.forEach(business => {

            //copy paste reduce method: --don't forget to add  ${totalOrders} in html rep below--
        ...
        // Set the gathered HTML content to the container's innerHTML
    ...
    //export a copy of database for other modules; 
    //above is html rep of some info in database not actual database is returned
